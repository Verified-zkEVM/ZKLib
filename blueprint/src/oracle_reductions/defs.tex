...
\begin{definition}[Knowledge Soundness]
    ...
    \uses{def:oracle_reduction, def:straightline_extractor}
\end{definition}
...
\begin{definition}[Round-by-Round Soundness]
    ...
    \uses{def:oracle_reduction, def:state_function}
\end{definition}
...
\begin{definition}[Round-by-Round Knowledge Soundness]
    ...
    \uses{def:oracle_reduction, def:state_function, def:rbr_extractor}
\end{definition}
