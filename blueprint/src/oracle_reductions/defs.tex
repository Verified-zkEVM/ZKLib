...
\begin{definition}[Interactive Reduction Execution]
    ...
    \lean{Reduction.run}
    \uses{def:prover_run, def:verifier_run}
\end{definition}
...
\begin{definition}[Knowledge Soundness]
    ...
    \uses{def:interactive_oracle_reduction, def:straightline_extractor}
\end{definition}
...
\begin{definition}[Round-by-Round Soundness]
    ...
    \uses{def:interactive_oracle_reduction, def:state_function}
\end{definition}
...
\begin{definition}[Round-by-Round Knowledge Soundness]
    ...
    \uses{def:interactive_oracle_reduction, def:state_function, def:rbr_extractor}
\end{definition}
...
\begin{definition}[Oracle Verifier RBR Knowledge Soundness]
    ...
    \uses{def:round_by_round_knowledge_soundness}
\end{definition}
